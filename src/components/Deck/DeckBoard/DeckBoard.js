            ...
            <section className="deck-board-section">
                <div className="deck-board-top-part-div">
                    ...
                    <div className="deck-board-btns-div">
                        <button onClick={ showDeckEditButton } className="deck-board-btn">Edit Deck</button>
                        <button onClick={ onDeckDelete } className="deck-board-btn">Delete Deck</button>
                    </div>
                </div>
                <div className="edit-deck-form-div" style={{ display: deck_edit_display}}>
                    <form className="deck-form" onSubmit={ onDeckEdit }>
                        ...
                        <input 
                            ...
                            />
                        <br />
                        <button type="submit" id="edit-deck" className="deck-btn">Edit Deck</button>
                    </form>
                </div>
